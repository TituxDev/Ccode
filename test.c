...
int main ( int argc , char **argv){
    ...
    if ( functionselect == _FUNCTION_LIST ) return 254 ;
    printf( "\n" );
    switch ( functionselect ){
        ...
        case _ISNOTPAR :    
            ...
            printf( "Is even number?: %s" , answer[ISNOTPAR( strtoint( argv[2] ) )] ) ;
            break ;
        ...
        case _ABS :         
            ...
            printf( "Absolute value: %i" , ABS( strtoint( &argv[ 2 ][ 0 ] ) ) ) ;
            break ;
        ...
        case _ROUNDUP :     
            ...
            if( aux= argc < 4 ) break ;
            printf( "Next number that is multiple of base from factor: %i" , ROUNDUP( strtoint( argv[2] ) , strtoint( argv[3] ) ) ) ;
            break ;
        ...
        case _BOOLEAN :     
            ...
            printf("Boolean value: %i" , BOOLEAN( strtouint( argv[2] ) ) ) ;
            break ;
        ...
        case _SWAP :         
            ...
            if( aux= argc < 3 ) break ;
            copyargv[0]= strtouint( argv[2] ) ;
            copyargv[1]= strtouint( argv[3] ) ;
        ...
        case _BIT :          
            ...
            if( aux= argc < 3 ) break ;
            for( uint j= 2 ; j < argc ; j++ ) for( uint i= 0 ; argv[j][i] ; i++ ) if( ISDIGIT( argv[j][i] ) )  copyargv[j - 2]= strtouint( argv[j] ); else return 251 ;
        ...
        case _ISBITUP :
            ...
            for( uint j= 2 ; j < argc ; j++ ) for( uint i= 0 ; argv[j][i] ; i++ ) if( ISDIGIT( argv[j][i] ) )  copyargv[j - 2]= strtouint( argv[j] ); else return 251 ;
            printf( "BITMASK_A:\t" ) ;
            for( uint i= strtoint( argv[2] ) ; i ; i= i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nBITMASK_B:\t" ) ;
            for( uint i= strtoint( argv[3] ) ; i ; i= i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nBIT_AND:\t" ) ;
            for( uint i= ISBITUP( strtouint( argv[2] ) , strtouint( argv[3] ) ) ; i ; i= i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nDecimal value:\t%i" , ISBITUP( strtouint( argv[2] ) , strtouint( argv[3] ) ) ) ;
            printf( "\nIs there at least one up bit coincidence? %s" , answer[BOOLEAN( ISBITUP( strtouint( argv[2] ) , strtouint( argv[3] ) ) )] ) ;
            break ;
        ...
        case _ISMASKON :    
            ...
            printf( "\nBITMASK_B:\t" ) ;
            for( uint i= strtoint( argv[3] ) ; i ; i= i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nAre all the bits up in B  also up in A? %s" , answer[ISMASKON( strtouint( argv[2] ) , strtouint( argv[3] ) )] ) ;
            break ;
        ...
        case _UBITS :       
            ...
            printf( "\nFINAL MASK:\t" ) ;
            aux= strtouint( argv[2] ) ;
            for( UBITS( aux , strtouint( argv[3] ) ) ; aux ; aux= aux >> 1 ) printf( "%li", ISBITUP( aux , 1 ) ) ;
            aux= strtouint( argv[2] ) ;
            printf( "\nDecimal value:\t%li" , UBITS( aux , strtouint( argv[3] ) ) ) ;
            aux= 0 ;
            break ;
        ...
        case _DBITS :       
            ...
            for( uint i= strtoint( argv[2] ) ; i ; i= i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nDOWNMASK:\t" ) ;
            for( uint i= strtoint( argv[3] ) ; i ; i= (unsigned long)i >> 1 ) printf( "%i" , ISBITUP( i , 1 ) ) ;
            printf( "\nFINAL MASK:\t" ) ;
            aux= strtouint( argv[2] ) ;
            for( DBITS( aux , strtouint( argv[3] ) ) ; aux ; aux= aux >> 1 ) printf( "%li" , ISBITUP( aux , 1 ) ) ;
            aux= strtouint( argv[2] ) ;
            printf( "\nDecimal value:\t%li" , DBITS( aux , strtouint( argv[3] ) ) ) ;
            aux= 0 ;
            break ;
        ...
        case _SBITS :       
            ...
            printf( "\nFINAL MASK:\t" ) ;
            aux= strtouint( argv[2] ) ;
            for( SBITS( aux , strtouint( argv[3] ) ) ; aux ; aux= aux >> 1 ) printf( "%li", ISBITUP( aux , 1 ) ) ;
            aux= strtouint( argv[2] ) ;
            printf( "\nDecimal value:\t%li" , SBITS( aux , strtouint( argv[3] ) ) ) ;
            aux= 0 ;
            break ;
